...
//		- 동일한 메소드 이름에 대해서 시그니쳐가 다를 경우 다른 메소드로 식별 하는경우
//		-	시그니쳐 : 메소드의 입력매개변수의 갯수, 타입
//					 리턴타입은 시그니쳐에 포함되지 않습니다.
//		- 생성자, 메소드 
// 메소드 오버라이딩 (Method Overriding) : 상속관계일때 만 사용가능
//		- 부모의 메소드를 자식클래스에서 새롭게 정의 해서 사용하는 것
//		- 자식 클래스에서 부모 클래스의 메소드를 오버라이딩 하기 위한 조건
//			:1.리턴타입이 같아야 한다. 2. 메소드이름이 같아야한다. 3. 시그니쳐가 같아야한다.
//			:4. 접근 제어자는 부모클래스의 접근 제어자와 같거나 넓어야한다.
...
class B extends A{
	...
	@Override		//메소드 오버라이딩을 오류나지 않도록 방지하는 설정
