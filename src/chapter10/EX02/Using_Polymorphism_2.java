...
public class Using_Polymorphism_2 {
	...
	public static void main(String[] args) {
		...
		// 2. Person 객체 생성
			//a2는 Animal, Person 타입을 내포 하고 있고 , Animal 타입으로 지정
			//Animal 타입의 필드, 메소드만 접근가능, Person 타입으로 다운 캐스팅이 가능 
		Animal a2 = new Person();
		System.out.println(a2.name);
		
			//a2는 Person 타입으로 다운 캐스팅 
		Person p1 = (Person) a2;
		...
		System.out.println(p2.personName);
			//
		Animal a3 = p2;			//a3는 Aninmal, Person를 내포하고 있고, Animal 타입으로 지정
		System.out.println(a3.name);
//		System.out.println(a3.personName);
			//다운캐스팅
		Person p3 = (Person) a3; // p3는 Aninmal, Person를 내포하고 있고, Person 타입으로 지정
		System.out.println(p3.name);
		System.out.println(p3.personName);
		
		//4.Person_person 객체를 Animal 타입으로 생성
			// a4는 Animal,Person, Person_person 타입을 내포 하고 있고, Animal 타입으로 지정
		...
		//6. Person_person객체를 Person 타입으로 생성
