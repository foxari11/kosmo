...
public class Test_A {
	...
	public static void main(String[] args) {
		...
		System.out.println(a1.n); 	// 정적필드 출력 : 객체 생성 후 , 객체 없이도 출력
		
		// 객체 생성 없이 출력 (클래스 이름.n)
		System.out.println(" == 객체 생성없이 출력 == ");
		System.out.println(A.n);	// 스태틱 필드는 객체가 필요 없이 클래스만으로 가능하구나..
									// 정적필드 출력 : 클래스명.n
//		System.out.println(A.m);	// 인스턴스 필드 : 반드시 객체 생성후에 객체이름.n 해야됨 
