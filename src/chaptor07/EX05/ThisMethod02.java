...
// Aaa 클래스 : 여러개의 생성자 사용시 this () 없이 사용한 경우 : 중복된 값을 매번 입력해야함.
...
public class ThisMethod02 {
	...
	public static void main(String[] args) {
		...
		Aaa aaa2 = new Aaa(10); // 매개 변수 1개인 생성자 호출 
		aaa2.print();
		
		Aaa aaa3= new Aaa(10,20); // 매개 변수 2개인 생성자 호출
		aaa3.print();
		//2. 3개의 객체 생성(this()사용)
		...
		Bbb bbb2 = new Bbb(10); // 매개 변수 1개인 생성자 호출 
		bbb2.print();
		
		Bbb bbb3 = new Bbb(10,20); // 매개 변수 2개인 생성자 호출
		bbb3.print();
