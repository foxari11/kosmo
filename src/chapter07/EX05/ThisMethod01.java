...
class Abc{
	...
	Abc(int a){
		this();          // 기본생성자를 호출 , this () 인풋 없는 생성자 호출 
...
public class ThisMethod01 {
	...
	public static void main(String[] args) {
		...
		// 		-- 반드시 생성자 내부에서 사용됨, 메소드 내부에서는 사용 할 수 없음.
		//      -- 반드시 생성자 첫번째 라인에 위치해야한다.
		System.out.println("===== 기본 생성자 호출 =====");
		Abc abc1 = new Abc(); // 기본 생성자 호출 
		
		System.out.println("===== 매개 변수가 1개인 생성자 호출 =====");
		Abc abc2 = new Abc(50);
		
		System.out.println("===== 매개 변수가 2개인 생성자 호출 =====");
		Abc abc3 = new Abc(40, "오늘");
		    
		System.out.println("===== 매개 변수가 3개인 생성자 호출 =====");
		Abc abc4 = new Abc(40,"오늘" ,"날씨");
