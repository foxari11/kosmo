...
public class Using_Method07 {
	...
	static void print(int a) {
		System.out.println(a + " : 값이 입력되었습니다. - 매개 변수: 정수");
	}
	//위의 메소드와 시그니쳐가 같다.
	//static void print(int c) {
		// 매개변수의 타입과 갯수가 같아서 오류 발생: 시그니쳐가 같다 : 매소드명 , 매개변수의 타입,갯수
	//}
	...
	/* 위의 메소드와 시그니쳐가 동일하다. : 메소드명 입력매개변수 타입 입력매개변수 갯수 
	 * static int print (int c, double d) {
		System.out.println(" 시그니처 오류 ");
	}
	*/
