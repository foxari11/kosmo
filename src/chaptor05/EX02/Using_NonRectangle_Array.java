...
public class Using_NonRectangle_Array {
	...
	public static void main(String[] args) {
		...
		// 1. 방법 1 : 비정방형 배열 선언 후 방크기를 생성 후 값 할당
        ...
        System.out.println("========================");
        // 2. 방법 2 : 비정방향 배열 선언 시 값을 할당. 
        
        int [][] arr2 = new int[2][];     // 비정방형 배열 선언 : 행의 갯수만 먼저 선언, 열은 선언 X 
