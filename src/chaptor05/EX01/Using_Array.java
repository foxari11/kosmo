...
public class Using_Array {
	...
	// 참조 자료형인 경우 : RAM 에 Stack 영역에 변수명이 저장이 되고, 
	...
	// 배열 변수 a를 선언
	int [] a = new int [5]; //a는 참조 변수 ( 참조 주소값을 가지고 있다.)
	// 배열 a 변수의 방 크기 5개 생성 후 주소 값 a에 할당해라.
    ...
    System.out.println("배열변수 a 방의 갯수 : " + a.length); // 배열 방의 총 갯수 
		
	System.out.println("==for 문에서 a.length를 사용해서 출력==");	
    ...
    // Arrays.toStrimg(a) 로 출력 // 배열의 모든 값을 출력 
