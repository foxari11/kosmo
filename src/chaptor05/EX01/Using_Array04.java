...
public class Using_Array04 {
	...
	public static void main(String[] args) {
		...
		//   - 참조 자료형 : 변수는 Stack 저장, 값은 Heap에 저장.
		...
		// 2. 방의 갯수를 변경할 수 없다. (정적)
		    ...
		    //     - 초기값을 넣지 않는 경우 JVM이 자동으로 넣습니다.
		    //     -- 정수 : 0, 실수: 0.0 boolean : false
		    //     -- 참조자료형일 경우 : null < 비어있는 상태 (0은 아님)
		
		// 1. 배열 선언과 초기화 
	    int [] a = new int[5];
	       // int 배열 변수 a를 선언 
	       // new : Heap 공간에 int 배열방 5개를 생성해서 Heap 주소를 a 변수에 할당 
	   ...
	   System.out.println("=========for 사용해서 입력,출력=============");
	    ...
	    System.out.println("=============a.length==============="); // 배열 방의 갯수 
	     ...
	     //각 방의 값을 입력
	      ...
	      // 향상된 for문
	      System.out.println("====향상된 for 문 사용 출력=====");
	    for (int k: a) {
