...
public class Using_String05 {
	...
	public static void main(String[] args) {
        ...
        // 2-3 lastIndexOf () : 해당 글자에 대한 방번호를 출력 , 오른쪽(끝) ==> 왼쪽(처음)
        
        System.out.println(str1.indexOf('a'));           // 7  'a' 문자의 방번호 
        System.out.println(str1.lastIndexOf('a'));       // 9  뒤에서 'a'문자의 방번호 
        System.out.println(str1.indexOf('a',8));         // 9  a라는 문자를 8번방 이후부터 검색 
        System.out.println(str1.lastIndexOf('a',8));     // 7  
        System.out.println(str1.indexOf("Java"));        // 6  "Java" 문자열의 방번호를 찾음
        System.out.println(str1.lastIndexOf("Java"));    // 6  "Java" 문자열의 방번호를 찾음
        
        
		System.out.println(str2.indexOf("하세요"));        // 2 
		System.out.println(str1.indexOf("bye"));         // -1 없는 내용을 검색할 때
		...
		String str5 = str3.concat(str4);                // concat = + 와 같음 
		System.out.println(str5);
		
		// 4. 문자열 ==> byte[]  ( getByte()) ,  문자열 => char[] (toCharArray())
