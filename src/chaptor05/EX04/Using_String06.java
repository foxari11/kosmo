...
public class Using_String06 {
	...
	public static void main(String[] args) {
		// String 의 다양한 메소드
		// 5. 문자열 수정 ( toLowerCase(), to UpperCase() )
		//                  소문자로 변환       대문자로 변환 
	    ...
	    // substring () : 글자를 잘라서 출력  (0,5), 0은 포함 5는 미포함 ( 0 < 5 라고 생각)
	    System.out.println(str1.substring(0, 5));  //index 0 ~ index 5까지 잘라라
	       // Java
	    System.out.println(str1.substring(3, 8));  // 3은 포함 , 8은 미포함 
	       // a Stu
	    System.out.println(str1.substring(5));     // index 5번방 뒤로 다 잘라라
	       // Study
	    ...
	    //공백을 기준으로 모두 잘라서 배열 저장 후 출력 : for , Enhanced for, Arrays.toString;
	    String [] a = " 오늘은 날씨가 매우 맑습니다. 참 화창한 날씨 입니다. ".split(" ");
	    ...
	    //6. 문자열 비교 ( == ) : 참조 자료형 일 때 Stack의 주소를 비교 
